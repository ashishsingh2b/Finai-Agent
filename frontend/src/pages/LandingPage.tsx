...
export const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0B] flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-[#253746]/20">
            ...
            {/* Glowing Orbs */}
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#253746]/20 rounded-full blur-[120px] pointer-events-none animate-pulse-slow"></div>
            ...
            <div className="relative z-10 flex flex-col items-center space-y-10 animate-in fade-in zoom-in duration-700">
                ...
                <div className="flex flex-col items-center space-y-6">
                    <div className="relative group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-[#253746] to-blue-400 rounded-3xl blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
                        <div className="relative w-24 h-24 bg-[#0F172A] rounded-2xl flex items-center justify-center border border-[#253746]/30 shadow-2xl">
                            <BarChart3 className="text-[#253746] w-12 h-12" />
                        </div>
                    </div>
                    ...
                    <div className="text-center space-y-3">
                        ...
                        <div className="flex items-center justify-center gap-3">
                            <div className="h-px w-8 bg-[#253746]/50"></div>
                            <p className="text-[#253746] font-bold text-xs uppercase tracking-[0.4em] text-shadow">
                                {t('landing.subtitle')}
                            </p>
                            <div className="h-px w-8 bg-[#253746]/50"></div>
                        </div>
                ...
                >
                    <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-[#253746] to-blue-600 opacity-90 group-hover:opacity-100 transition-opacity"></div>
